package com.hoangtien2k3.food_order_app.repository
...
object DataInitHome {
    ...
    val listDemoFoodDomain = listOf<FoodDomain>(
        FoodDomain("Bánh Pizza", "rice", "bánh pizza là loại bánh cực kỳ thơm ngon và hấp dẫn.", 195.0),
        FoodDomain("Ngũ cốc", "noodle", "Ngũ cốc là loại thức uống cực kỳ thơm ngon và hấp dẫn.", 15.0),
        FoodDomain("Nước uống", "slider_2", "Nước uống là loại đồ uống cực kỳ thơm ngon và hấp dẫn.", 46.0),
        FoodDomain("Trái cây", "slider_3", "Trái cây là loại hoa quả cực kỳ thơm ngon và hấp dẫn.", 27.0),
