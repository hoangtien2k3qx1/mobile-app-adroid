...
public class ChatFragment extends Fragment {
    ...
    private void referencesComponent() {
        ...
        btnGioHang.setOnClickListener(view -> {
            resetAttribute();
            btnGioHang.setBackground(ContextCompat.getDrawable(requireContext(), R.color.blue));
        ...
        btnDangDen.setOnClickListener(view -> {
            resetAttribute(); // resert tất cả nút ấn về màu trắng
            btnDangDen.setBackground(ContextCompat.getDrawable(requireContext(), R.color.blue)); // setting nút ấn trỏ đến là màu blue
            tvDangDen.setTextColor(Color.WHITE); // xet chữ màu trắng
        ...
        btnLichSu.setOnClickListener(view -> {
            resetAttribute();
            btnLichSu.setBackground(ContextCompat.getDrawable(requireContext(), R.color.blue));
